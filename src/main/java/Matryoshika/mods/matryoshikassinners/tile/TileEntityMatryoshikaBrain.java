...
public class TileEntityMatryoshikaBrain extends TileEntity implements IInventory {
	...
	public void TileEntitymatryoshikaBrain() {
		this.setCustomName("Matryoshika Brain");
	}
	...
	public void closeInventory() {
        if (this.getBlockType() instanceof BlockMatryoshikaBrain)
        {
    ...
    public String getInventoryName() {
        return this.hasCustomInventoryName() ? this.customName : "matryoshikabrain.name";
    }
